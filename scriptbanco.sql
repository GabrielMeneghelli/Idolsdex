...
-- Karin Benzema
INSERT IGNORE INTO JogadorClube (JogadorId, ClubeId, AnoInicio, AnoFim) VALUES
((SELECT Id FROM Jogador WHERE Nome = 'Karin Benzema'), (SELECT Id FROM Clube WHERE Nome = 'Lyon'), 2005, 2009),
((SELECT Id FROM Jogador WHERE Nome = 'Karin Benzema'), (SELECT Id FROM Clube WHERE Nome = 'Real Madrid'), 2009, 2023),
((SELECT Id FROM Jogador WHERE Nome = 'Karin Benzema'), (SELECT Id FROM Clube WHERE Nome = 'Al-Ittihad'), 2023, 2025);
